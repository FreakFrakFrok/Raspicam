...
try:
    ...
    while True:
        ...
        if x > 5.2:
            ...
            os.system("sudo raspistill -n -ex sports -t 400 -w 640 -h 480 -q 10 -th none -o /Edatasoluciones/Detection/MDetection2.jpg")
            ...
            os.system("sudo raspistill -n -ex sports -t 400 -w 640 -h 480 -q 10 -th none -o /Edatasoluciones/Detection/MDetection1.jpg")
            img1 = Image.open('/Edatasoluciones/Detection/MDetection1.jpg').convert('LA')
